...
SIGNAL \key1|key_flag~clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \key1|key_flag~clkctrl_outclk\ : std_logic;
...
\key1|key_flag~clkctrl_INCLK_bus\ <= (gnd & gnd & gnd & \key1|key_flag~regout\);
...
PORT MAP (
	clk => \clk~clkctrl_outclk\,
	sdata => \key1|cnt_20ms[12]~44_combout\,
	sclr => \key~combout\,
	sload => VCC,
	ena => \key1|always0~0_combout\,
	devclrn => ww_devclrn,
...
-- Equation(s):
-- \key1|Equal1~3_combout\ = (\key1|cnt_20ms\(9) & (!\key1|cnt_20ms\(12) & (!\key1|cnt_20ms\(11) & !\key1|cnt_20ms\(10))))
...
-- Equation(s):
-- \key1|Equal1~5_combout\ = (\key1|Equal1~2_combout\ & (\key1|Equal1~1_combout\ & (\key1|Equal1~3_combout\ & \key1|Equal1~4_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \key1|Equal1~2_combout\,
	datab => \key1|Equal1~1_combout\,
	datac => \key1|Equal1~3_combout\,
...
-- Equation(s):
-- \key1|Equal1~6_combout\ = (\key1|Equal1~0_combout\ & (!\key1|cnt_20ms\(0) & \key1|Equal1~5_combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \key1|Equal1~0_combout\,
	datac => \key1|cnt_20ms\(0),
...
-- Equation(s):
-- \key1|always0~0_combout\ = (\key~combout\) # (((!\key1|Equal1~5_combout\) # (!\key1|Equal1~0_combout\)) # (!\key1|cnt_20ms\(0)))
...
-- Location: CLKCTRL_G3
\key1|key_flag~clkctrl\ : cycloneii_clkctrl
-- pragma translate_off
GENERIC MAP (
...
-- pragma translate_on
PORT MAP (
	inclk => \key1|key_flag~clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \key1|key_flag~clkctrl_outclk\);
...
PORT MAP (
	clk => \key1|key_flag~clkctrl_outclk\,
